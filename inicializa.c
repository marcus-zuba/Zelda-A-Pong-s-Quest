...
void inicializa(){
    ...
    idZeldaNormal = carregaTextura("C:/Users/felip/TP1-CG/sair.png");
    ...
    pausa = carregaTextura("C:/Users/felip/TP1-CG/pause.png");
    ...
    logo.idTextura = carregaTextura("C:/Users/felip/TP1-CG/logo-loz.png");
    logo.quadrosHorizontais = 4;
    logo.quadroAtual=0;

    Av.idTextura = carregaTextura("C:/Users/felip/TP1-CG/BOTAO_Ave.png");
    Av.quadrosHorizontais =2;
    Av.quadroAtual=0;

    Cl.idTextura = carregaTextura("C:/Users/felip/TP1-CG/BOTAO_Cla.png");
    Cl.quadrosHorizontais =2;
    Cl.quadroAtual=0;

    heart.idTextura = carregaTextura("C:/Users/felip/TP1-CG/heart.png");
    heart.quadrosHorizontais =11;

    heartG.idTextura = carregaTextura("C:/Users/felip/TP1-CG/heart.png");
    heartG.quadrosHorizontais =11;

    linkop.idTextura = carregaTextura("C:/Users/felip/TP1-CG/link_op_anim.png");
    linkop.quadrosHorizontais =4;
    linkop.quadroAtual=0;

    zeldaop.idTextura = carregaTextura("C:/Users/felip/TP1-CG/zelda_op_anim.png");
    zeldaop.quadrosHorizontais =4;
    zeldaop.quadroAtual=0;

    hist.idTextura = carregaTextura("C:/Users/felip/TP1-CG/historia.png");
    hist.quadrosHorizontais =24;
    hist.quadroAtual=0;

    tri.idTextura = carregaTextura("C:/Users/felip/TP1-CG/triforce.png");
    tri.quadrosHorizontais = 4;
    tri.quadroAtual =0;

    tri2.idTextura = carregaTextura("C:/Users/felip/TP1-CG/triforce.png");
    tri2.quadrosHorizontais = 4;
    tri2.quadroAtual =0;

    fases.idTextura = carregaTextura("C:/Users/felip/TP1-CG/fases.png");
    fases.quadrosHorizontais = 4;
    fases.quadroAtual =0;

    backg.idTextura = carregaTextura("C:/Users/felip/TP1-CG/back.png");
